        ...
        <div class="col">
          <q-card square flat bordered>
            <q-card-section class="white">
              <div class="text-h6 goString"><marquee>{{message}}</marquee></div>
            </q-card-section>
            <div class="row">
              <div class="col">
                <q-tabs
            ...
            <div class="row">
              <div class="col">
                ...
                <s-carusel-card v-show="tab === 'tabOne'" v-if="slideToday" :users="todays" :slide="slideToday" datetime="today" />
                <s-carusel-card v-show="tab === 'tabTwo'" v-if="slideTomorrow" :users="tomorrow" :slide="slideTomorrow" datetime="tomorrow" />
                <s-carusel-card v-show="tab === 'tabThree'" v-if="slideAfterTomorrow" :users="afterTomorrow" :slide="slideAfterTomorrow" datetime="afterTomorrow" />
...
export default {
    ...
    async created () {
       await this.$store.dispatch('setBirthdays')
        .then (res => {
