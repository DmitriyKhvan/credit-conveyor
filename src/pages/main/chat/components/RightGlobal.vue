      ...
      <template v-else>
        ...
        >
          ...
          <div class="col" @click="selectChat(chat.chat_id)">
            <div v-if="chat.type === 1" class="text-subtitle1">
              <b v-html="chatName(chat.to_name)"></b>
            </div>
            <div v-else class="text-subtitle1">
              <b v-html="chat.to_name"></b>
            </div>
            <div class="text-caption">
...
.roundedBlock:hover .actionsBlock,
.active .actionsBlock {
