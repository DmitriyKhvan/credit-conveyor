        ...
        <div class="q-gutter-y-sm q-gutter-x-md column">
          <div class="row">
            ...
            <q-select
              ...
              :rules="[
                val => $v.details.level.required || $t('tables.education.topicNameError')
              ]"
              lazy-rules
            />
            <div class="row justify-between">
            ...
            <div class="row">
              <q-btn
                v-if="variantAmount<5"
                color="primary"
                icon="add"
                @click="addOneMoreVariant()"
              />
            </div>
          </div>
        </div>
...
export default {
  data() {
    return {
      ...
      details: {
        id: null,
        topic_id: this.$store.state.education.topicId,
        question_text: null,
        level: null,
        variants: [
          {
  ...
  methods: {
    ...
    chooseRightAnswer() {
      ...
      // console.log(
      //   this.details.variants[1].answer_text +
      //     ":" +
      //     this.details.variants[1].answer_status
      // );
    }
  }
};
