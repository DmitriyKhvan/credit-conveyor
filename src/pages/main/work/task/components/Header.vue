<template>
  <div>
    ...
    <div class="row q-gutter-lg header q-pb-md" :class="viewTasks ? 'q-pt-none': 'q-pt-md'">
      ...
      <div class="q-pa-sm bg-white vList" @click="viewChangeTasks">
        <img v-if="viewTasks" src="@/assets/icons/Unchecked-Checkbox-active.svg" alt="">
        <img v-else src="@/assets/icons/Unchecked-Checkbox.svg" alt="">
      </div>
