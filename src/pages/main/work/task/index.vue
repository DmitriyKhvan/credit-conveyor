    ...
    <div class="q-pa-md">
      <q-toolbar class="shadow-2 rounded-borders">
        ...
        <q-tabs v-model="tab" inline-label stretch>
          ...
          <q-tab name="tab2" label="Завершено" icon="check_circle">
      ...
      <div class="sub_menu">
        <div class="filterBlock">
          <q-select dense filled v-model="model" :options="optionsFilter" label="Действия" />
        </div>
      ...
      <div
        ...
        <div class="col content">
          ...
          <div class="row">
            ...
            <div class="col despBlock">
              <q-btn color="white text-black" icon="person" size="sm" label="Ответсвенные" @click="usersPopup = true" />
        ...
        <div class="col-1 text-right actions">
          <q-btn class="white text-black q-mb-sm" label="Открыть" @click="taskPopup = true" /><br>
          <q-dialog 
            v-model="taskPopup"
            full-width
            full-height
