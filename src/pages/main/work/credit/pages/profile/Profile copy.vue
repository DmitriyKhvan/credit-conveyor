      ...
      <form @submit.prevent.stop="onSubmit">
            ...
            <div class="row q-col-gutter-md">
              <div class="col-4">
                <q-input
                  ...
                  v-model="personalData.passportData.dateStart"
                  mask="##.##.####"
                  lazy-rules
                  :rules="[
                    val =>
              ...
              <div class="col-4">
                <q-input
                  ...
                  v-model="personalData.passportData.dateFinish"
                  mask="##.##.####"
                  lazy-rules
                  :rules="[
                    val =>
                ...
                <div class="row  q-col-gutter-md">
                  <div class="col-4">
                    <q-input
                      square
                      outlined
                      v-model="personalData.permanentRegistration.district"
                      dense
                      label="Район"
                    />
                  </div>
                ...
                <div class="row q-col-gutter-md">
                  ...
                  <div class="col-4">
                    <q-input
                      ...
                      outlined
                      v-model="
                        personalData.permanentRegistration.apartmentNumber
                      "
                      dense
                  ...
                  <div class="col-4">
                    <q-input
                      ...
                      outlined
                      v-model="
                        personalData.permanentRegistration.typeOfOwnership
                      "
                      dense
                      label="Вид владения"
                    />
                  ...
                  <div class="row  q-col-gutter-md">
                    <div class="col-4">
                      <q-input
                        square
                        outlined
                        v-model="personalData.actualRegistration.district"
                        dense
                        label="Район"
                      />
                    </div>
                  ...
                  <div class="row q-col-gutter-md">
                    ...
                    <div class="col-4">
                      <q-input
                        ...
                        outlined
                        v-model="
                          personalData.actualRegistration.apartmentNumber
                        "
                        dense
                        label="Номер квартиры"
                      />
                    ...
                    <div class="col-4">
                      <q-input
                        ...
                        outlined
                        v-model="
                          personalData.actualRegistration.typeOfOwnership
                        "
                        dense
                        label="Вид владения"
                      />
                  ...
                  <div class="row  q-col-gutter-md">
                    <div class="col-4">
                      <q-input
                        square
                        outlined
                        v-model="personalData.temporaryRegistration.district"
                        dense
                        label="Район"
                      />
                    </div>
        ...
        <div class="family-status tab">
          ...
          <div class="tab-content" ref="tabContent">
            <div class="row q-col-gutter-md">
              ...
              <div class="col-4">
                <q-input
                  v-if="personalData.family.children"
                  square
                  outlined
              ...
              <div class="row q-col-gutter-md">
                  <div class="col-4">
                    <q-input
                      ...
                      dense
                      label="Дата выдачи паспорта"
                      v-model="relative.passportData.dateStart"
                      mask="##.##.####"
                      lazy-rules
                      :rules="[
                        val =>
                        ...
                        <q-icon name="event" class="cursor-pointer">
                          ...
                          >
                            <q-date
                              ...
                              @input="
                                () =>
                                  $refs.qDateRelativePassportDateStart[index].hide()
                              "
                            />
                          </q-popup-proxy>
                        </q-icon>
                  ...
                  <div class="col-4">
                    <q-input
                      ...
                      dense
                      label="Дата окончания действия паспорта"
                      v-model="relative.passportData.dateFinish"
                      mask="##.##.####"
                      lazy-rules
                      :rules="[
                        val =>
                        ...
                        <q-icon name="event" class="cursor-pointer">
                          ...
                          >
                            <q-date
                              ...
                              @input="
                                () =>
                                  $refs.qDateRelativePassportDateFinish[index].hide()
                              "
                            />
                          </q-popup-proxy>
                        </q-icon>
        ...
        <div class="infoWork tab">
          ...
          <div class="tab-content" ref="tabContent">
            ...
            <template
              v-if="personalData.activity.kind === dictionaries.MainWorkType.items[0].value"
            >
              <div class="row q-col-gutter-md">
                <div class="col-4">
                  <q-input
            ...
            <template
              v-if="personalData.activity.kind === dictionaries.MainWorkType.items[1].value 
                || personalData.activity.kind === dictionaries.MainWorkType.items[2].value"
            >
              <div class="row q-col-gutter-md">
                <div class="col-4">
                  <q-select
        ...
        <div class="expense-income tab">
          ...
          <div class="tab-content" ref="tabContent">
            ...
            <div class="row q-col-gutter-md">
              ...
              <template
                v-if="personalData.expenseIncome.externalIncome"
              >
                <div class="col-4">
                  <q-input
                    square
                    outlined
                    v-model.number="
                      personalData.expenseIncome.externalIncomeSize
                    "
                    type="number"
                    dense
        ...
        <div class="properties">
          ...
          <div class="tab-content" ref="tabContent">
            <h5
              v-if="!personalData.properties.length"
            ...
            <div class="row q-col-gutter-md">
              <div class="col-4">
                <q-select
                  ...
                  :options="dictionaries.PaymentsType.items"
                  dense
...
export default {
    ...
    return {
      ...
      dictionaries: {
        ...
        Graduation: {
          items: [
            {
              label: "Ученая степень/МВА",
              value: "1"
            },
            {
              label: "Несколько высших",
              value: "2"
            },
            {
              label: "Высшее",
        ...
        VehicleType: {
          items: [
            ...
            {
              label: "Катамаранлар ва ?айи?лар",
              value: "15"
            },
            {
              label: "Йўловчилар ташиладиган тиркама ва ярим тиркама",
              value: "16"
            },
            {
              label: "Микроавтобус",
            ...
            {
              label: "Шатакчи автомобиллар",
              value: "18"
            },
            {
              label: "Махсус автотранспорт",
              value: "19"
            },
            {
              label: "Техника ва ?ишло? хўжалик машиналари",
              value: "20"
            },
            {
              label: "Юк ташиладиган тиркама ва ярим тиркама",
              value: "21"
            },
            {
              label: "Махсус тиркама ва ярим тиркама",
              value: "22"
            }
          ]
        },
        ...
        DocumentType: {
          items: [
            ...
            {
              label: "Биометрический паспорт гражданина Респ.Узбекистан",
              value: "8"
            }
          ]
        },
        ...
        LoanProduct: {
          items: [
            {
              label: "Потребительский кредит (беззалоговый)",
              value: "2"
            },
            {
              label: "Овердрафт (беззалоговый)",
              value: "3"
            },
            {
              label: "Микрозайм",
        ...
        PositionType: {
          items: [
            ...
            {
              label: "Руководитель начального звена",
              value: "5"
            },
            {
              label: "Специалист",
        ...
        Region: {
          items: [
            ...
            {
              label: "БУХОРО ВИЛОЯТИ",
              value: "2"
            },
            {
              label: "ЖИЗЗАХ ВИЛОЯТИ",
              value: "3"
            },
            {
              label: "КАШКАДАРЁ ВИЛОЯТИ",
              value: "4"
            },
            {
            ...
            {
              label: "НАМАНГАН ВИЛОЯТИ",
              value: "6"
            },
            {
              label: "САМАРКАНД ВИЛОЯТИ",
              value: "7"
            },
            {
              label: "СУРХОНДАРЁ ВИЛОЯТИ",
              value: "8"
            },
            {
              label: "СИРДАРЁ ВИЛОЯТИ",
              value: "9"
            },
            {
              label: "ТОШКЕНТ ШАХРИ",
            ...
            {
              label: "ФАРГОНА ВИЛОЯТИ",
              value: "12"
            },
            {
              label: "ХОРАЗМ ВИЛОЯТИ",
              value: "13"
            },
            {
              label: "КОРАКАЛПОГИСТОН РЕСПУБЛИКАСИ",
              value: "14"
            }
          ]
        },
  ...
  methods: {
    onSubmit() {
      ...
      if (
        this.sameRegistration === this.options.sameRegistration[1] ||
        this.sameRegistration === ""
      ) {
