        ...
        <div class="row q-col-gutter-md">
          <div class="col-4">
            <q-input
              ...
              dense
              label="Фамилия"
              :rules="[val => !!val || 'Введите фамилию', val => fioValid(val)]"
            />
          </div>
          <div class="col-4">
            <q-input
          ...
          <div class="col-4">
            <q-input
              ...
              dense
              label="Отчество"
              :rules="[val => !!val || 'Введите отчество', val => mValid(val)]"
            />
          </div>
        </div>
        ...
        <div class="row q-col-gutter-md">
          ...
          <div class="col-4">
            <q-input
              ...
              :rules="[
                val =>
                  (val && val.length === 10) || 'Введите дату выдачи документа',
          ...
          <div class="row q-col-gutter-md">
            <div class="col-4">
              <q-input
                ...
                mask="+############"
                :rules="[
                  val => (val && val.length === 13) || 'Введите номер телефона',
                  val => phoneValid(val)
                ]"
              />
            </div>
